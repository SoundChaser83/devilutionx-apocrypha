...
const char *const MsgStrings[] = {
	...
	N_("Loading..."),
	N_("Saving..."),
	N_(/* TRANSLATORS: Shrine Text. Keep atmospheric. :) */ "Rebirth invites new opportunities"),
	...
	N_(/* TRANSLATORS: Shrine Text. Keep atmospheric. :) */ "Repent and be cleansed"),
	...
	N_(/* TRANSLATORS: Shrine Text. Keep atmospheric. :) */ "The blade calls to those who forsake it"),
	...
	N_(/* TRANSLATORS: Shrine Text. Keep atmospheric. :) */ "Spirit is naught but the pains of flesh"),
	N_(/* TRANSLATORS: Shrine Text. Keep atmospheric. :) */ "Decay waits for no one"),
	N_(/* TRANSLATORS: Shrine Text. Keep atmospheric. :) */ "To relinquish oneself is to achieve wisdom"),
